...
command.execute = function(message,args,client)
  ...
  if res.code == 200 then
    ...
    return {success = true, msg = "Welcome to (your discord server here), **"..body.robloxUsername.."**!"}
  elseif res.code == 404 then
    return {success = false, msg = "You're not verified with (your discord server here)! Verify here: <https://verify.eryn.io>"}
  else
