...
module.exports.execute = async (client, message, args) => {
    ...
    const embed = new RichEmbed()
        .setAuthor(`Leaderboard of all of Cappa!`, message.guild.iconURL)
        .setColor("RANDOM")
    ...
    leaderboard.forEach(u => {
        embed.addField(`${u.position}. ${client.users.get(u.id) ? client.users.get(u.id).tag : "Nobody#0000"}`, `${u.money} 💸`);
    });
